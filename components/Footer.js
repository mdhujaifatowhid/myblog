          ...
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href="https://x.com/HujaifaTowhid" aria-label="Twitter / X"><SocialIcon name="twitter" /></a>
							<a href="https://instagram.com/hujaifa.tired" aria-label="Instagram"><SocialIcon name="instagram" /></a>
							<a href="https://www.facebook.com/md.hujaifa.towhid" aria-label="Facebook"><SocialIcon name="facebook" /></a>
							<a href="https://www.linkedin.com/in/hujaifa-towhid/" aria-label="LinkedIn"><SocialIcon name="linkedin" /></a>
            </div>
          </div>
